...
public class TP04DomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<TP04DomainSharedModule>();
        });
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/Localization/TP04");

            options.DefaultResourceType = typeof(TP04Resource);
        ...
        {
            options.MapCodeNamespace("TP04", typeof(TP04Resource));
        });
    }
}
