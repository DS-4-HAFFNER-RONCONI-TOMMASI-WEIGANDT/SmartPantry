...
public class TP04DbContext :
    AbpDbContext<TP04DbContext>,
    ...
    IIdentityDbContext
{
    ...
    public TP04DbContext(DbContextOptions<TP04DbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(TP04Consts.DbTablePrefix + "Authors",
                TP04Consts.DbSchema);
        ...
        {
            b.ToTable(TP04Consts.DbTablePrefix + "Books",
                TP04Consts.DbSchema);
            b.ConfigureByConvention(); //auto configure for the base class props
