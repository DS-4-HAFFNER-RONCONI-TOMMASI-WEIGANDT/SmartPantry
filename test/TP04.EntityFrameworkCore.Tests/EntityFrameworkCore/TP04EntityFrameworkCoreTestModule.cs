...
[DependsOn(
    typeof(TP04ApplicationTestModule),
    typeof(TP04EntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
)]
public class TP04EntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new TP04DbContext(new DbContextOptionsBuilder<TP04DbContext>().UseSqlite(_database.ConnectionString).Options));
